...
public class VolleySingleton {
    private static com.example.agribot_cf.VolleySingleton mInstance;
     ...
     */
    public static synchronized com.example.agribot_cf.VolleySingleton getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new com.example.agribot_cf.VolleySingleton(context);
        }
        return mInstance;
    }
